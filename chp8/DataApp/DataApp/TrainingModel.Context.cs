...
namespace DataApp
{
    ...
    public partial class TrainingDataEntities : DbContext
    {
        ...
        public virtual ObjectResult<Ranking> GetPersonalRanking1(string athleteName, string eventType, Nullable<System.TimeSpan> swimTime, Nullable<System.TimeSpan> cycleTime, Nullable<System.TimeSpan> runTime, Nullable<System.TimeSpan> overallTime)
        {
            var athleteNameParameter = athleteName != null ?
                new ObjectParameter("AthleteName", athleteName) :
                new ObjectParameter("AthleteName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Ranking>("GetPersonalRanking1", athleteNameParameter, eventTypeParameter, swimTimeParameter, cycleTimeParameter, runTimeParameter, overallTimeParameter);
        }
    
        public virtual ObjectResult<Ranking> GetReferenceRanking1(string eventType, Nullable<System.TimeSpan> swimTime, Nullable<System.TimeSpan> cycleTime, Nullable<System.TimeSpan> runTime, Nullable<System.TimeSpan> overallTime)
        {
            var eventTypeParameter = eventType != null ?
                new ObjectParameter("EventType", eventType) :
                new ObjectParameter("EventType", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Ranking>("GetReferenceRanking1", eventTypeParameter, swimTimeParameter, cycleTimeParameter, runTimeParameter, overallTimeParameter);
        }
    }
}
